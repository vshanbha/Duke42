...
```bash
mvn test # all modules: spring-ai-cli-agent 49 + backend 14
...
```bash
# CLI Agent: 49 tests (44 run + 3 evals skipped without -Devals=true + Ollama,
...
|--------|---------|------|-------|
| `spring-ai-cli-agent/` | CLI Agent learning project | non-web | 49 (3 evals + 2 Docker-gated opt-in) |
